...
(function($, undefined) {
	...
	jPlayerPlaylist.prototype = {
		...
		_createItemHandlers: function() {
			...
			$(document).off("click", this.cssSelector.playlist + " a." + this.options.playlistOptions.itemClass).on("click", this.cssSelector.playlist + " a." + this.options.playlistOptions.itemClass, function() {
			...
			//replace live and die with on and off : $(xyz) die("click") -> $(document) off (xyz)
			// Create .live() handlers that disable free media links to force access via right click
			$(document).off("click", self.cssSelector.playlist + " a." + this.options.playlistOptions.freeItemClass).on("click",self.cssSelector.playlist + " a." + this.options.playlistOptions.freeItemClass, function() {
			...
			$(document).off("click", self.cssSelector.playlist + " a." + this.options.playlistOptions.removeItemClass).on("click", self.cssSelector.playlist + " a." + this.options.playlistOptions.removeItemClass,function() {
				var index = $(this).parent().parent().index();
				self.remove(index);
				$(this).blur();
				return false;
